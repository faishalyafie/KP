        ...
        <div class="col-lg">
            <div class="card o-hidden border-0 shadow-lg">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('admin/user'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm float-right mb-3"><i class=" fa-sm text-white-50"></i> User Active</a>
